...
var Drive = (
  /** @class */
  function() {
    function Drive2(filesystem, blocks, used, available, capacity, mounted) {
...
utils.Utils = void 0;
var os = __importStar(require$$0$1);
...
dist.getDiskInfoSync = getDiskInfo_1 = dist.getDiskInfo = void 0;
var darwin_1 = darwin;
var linux_1 = linux;
...
var getDiskInfo_1 = dist.getDiskInfo = getDiskInfo;
...
(async () => {
  const disks = await getDiskInfo_1();
  console.log(disks);
})();
